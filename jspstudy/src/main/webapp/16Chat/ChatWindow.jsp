...
<script>
   ...
   function enterKey() 
   {
      if(window.event.keyCode==13) // 13은 Enter키 코드 값
      {
         sendMessage();
      }
   }
   ...
   {
      chatWindow.innerHTML +="웹소켓 서버 연결해제<br>";      
   };
   ...
   webSocket.onmessage= function(event) 
   {
      ...
      if(content != "") // /대상 내용 하면 귓속말로 
      {
    	 if(content.match("/")){ // -> /를 포함하고 있으면 귓속말로 표현
