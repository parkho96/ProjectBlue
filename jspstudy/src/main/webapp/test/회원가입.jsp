...
<head>
	...
	<script type="text/javascript" src="/inc/common/js/lcslog.js?r=20221103"></script>
	<script type="text/javascript" src="/inc/common/js/nclk_v0.8.1.js?r=20221103"></script>
...
<form id="join_form" method="post" action="/user2/V2Join?m=end">
    <input type="hidden" id="token_sjoin" name="token_sjoin" value="eZMZbyv2wIsyO8q1">
...
<form name="form_ipin" method="post" action="">
    ...
    <input type="hidden" name="enc_data" value="">
</form>
...
<script type="text/JavaScript">
    ...
    function createRsaKey() {
        var rsa = new RSAKey();
        var sessionKey = "t9bXaWJKpduUX051";
        var keyName = "100018601";
        var eValue = "";
        var nValue = "010001";
